#!/usr/bin/env bash
# PortableAgents — Claude Code with default Anthropic API.
# Any arguments pass straight through to `claude`, e.g.:  ./claude.sh -p "hello"
set -euo pipefail
...
# --- default env (API keys — set your real keys or use OAuth login) ----------
CLAUDE_ENV="${CLAUDE_ENV:-$ROOT/config/env.sh}"
